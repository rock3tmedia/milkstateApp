...
var msJS = function(init_data){
    ...
    var load_view = function(url_obj){
        ...
        //get view link
        var data_link = data[view_loc][0]['data_link'];
        ...
        if(cur_states.url_data_count >= cur_states.post_url_data_count && cur_states.url_data_count > 0){
            ...
            for (i = 0; i < section_dif_val; i++) {
                ...
                //get current section which starts after "url_data"
                ...
                //get section data from first section
                ...
                if(!section_error){
                    ...
                    //check for current sections to store
                    if(current_section_data === undefined || current_section_data.length == 0){
                        
                        //get current sections
                        for (i2 = 0; i2 < current_section_data[0].length; i2++) {

                            var cur_section = current_section_data[0][i2];
